# Definition: hadoop::hadoop_cluster_config
#
#   This is a hadoop configuration
#
# Parameters:
#   - $clusterName - Name that uniquely identifies this configuration
...
#
define hadoop::hadoop_cluster_config($clusterName,$dataNodes,$fsDefaultName,$nameNodes) {
